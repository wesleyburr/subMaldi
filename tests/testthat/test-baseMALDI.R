...
avg <- avgSpectra(Master2, method = "mean", spec1 = "Blank1",
...
avg_sum <- avgSpectra(Master2, method = "sum", spec1 = "Blank1",
                      spec2 = "Blank2", spec3 = "Before1", spec4 = "Before2",
                      spec5 = "After1", spec6 = "After2")
avg_sum <- avg_sum[5,8]
...
subSp <- subSpectra(bef, Blank_Var = "Before1", Sample = "Before2", 
...
sneg <- subSpectra(bef, Blank_Var = "Before1", Sample = "Before2", 
